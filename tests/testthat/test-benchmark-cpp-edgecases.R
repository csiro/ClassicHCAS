test_that("bench_cpp handles cells with no valid neighbours without crashing", {
  ...
  histogram <- matrix(0.5, nrow = 10, ncol = 10)
...
test_that("bench_cpp supports different histogram bin settings across calls", {
  ...
  histogram_1 <- matrix(0.7, nrow = 10, ncol = 10)
  histogram_2 <- matrix(0.2, nrow = 6, ncol = 6)
