...
* A new histogram normalisation is added using R code (the `legacy = FALSE` argument) to remove edge effect.
* The zero-zero point in the raw histogram (self-assessment) is removed before normalisation.
