...
hcas_cpp <- function(rast_stack, sample_vals, histogram, xy_stats, xy_penalty = 0.0, num_vars = 0L, scale = 100000.0, within_km = 200, k_env = 50L, k_rs = 20L, bin_width = 0.03, bin_num = 400L, offset = 0L, pnorm = 1, confidence = 0.5, lambda = 2.0, exclude_slef = TRUE, make_su = FALSE, num_threads = -1L) {
    .Call('_ClassicHCAS_hcas_cpp', PACKAGE = 'ClassicHCAS', rast_stack, sample_vals, histogram, xy_stats, xy_penalty, num_vars, scale, within_km, k_env, k_rs, bin_width, bin_num, offset, pnorm, confidence, lambda, exclude_slef, make_su, num_threads)
}
