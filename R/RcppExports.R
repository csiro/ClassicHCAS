...
histo_test <- function(rs_vals, pr_vals, xy, within_km = 1000.0, bin_width = 0.05, bin_num = 650L, geographic = FALSE, num_threads = -1L) {
    .Call(`_ClassicHCAS_histo_test`, rs_vals, pr_vals, xy, within_km, bin_width, bin_num, geographic, num_threads)
}
